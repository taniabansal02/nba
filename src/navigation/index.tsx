  ...
  const BottomNavigation = () => {
    return (
      <BottomTabs.Navigator initialRouteName="Home" screenOptions={{ lazy: false }} >
        <BottomTabs.Screen component={Home} name={ScreenNameKeys.Home} options={{
          headerShown: false,
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name={ScreenNameKeys.CreateTeam} component={CreateTeam} options={{ headerShown: false }} />
